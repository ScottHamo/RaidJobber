    ...
    bosses = {
        ...
        },
        {
            ...
            jobs = {
                ...
                { slot = "Area 1 Melee", role = "Melee", text = "Area 1 melee DPS for tainted core side" },
                { slot = "Area 1 Healer", role = "Healer", text = "Area 1 healer for tainted core side" },
                { slot = "Area 1 Ranged", role = "Ranged", text = "Area 1 ranged DPS; hunter preferred" },
                { slot = "Area 2 Melee", role = "Melee", text = "Area 2 melee DPS for tainted core side" },
                { slot = "Area 2 Healer", role = "Healer", text = "Area 2 healer for tainted core side" },
                { slot = "Area 2 Ranged", role = "Ranged", text = "Area 2 ranged DPS; hunter preferred" },
                { slot = "Area 3 Melee", role = "Melee", text = "Area 3 melee DPS for tainted core side" },
                { slot = "Area 3 Healer", role = "Healer", text = "Area 3 healer for tainted core side" },
                { slot = "Area 3 Ranged", role = "Ranged", text = "Area 3 ranged DPS; hunter preferred" },
                { slot = "Area 4 Melee", role = "Melee", text = "Area 4 melee DPS for tainted core side" },
                { slot = "Area 4 Healer", role = "Healer", text = "Area 4 healer for tainted core side" },
                { slot = "Area 4 Ranged", role = "Ranged", text = "Area 4 ranged DPS; hunter preferred" },

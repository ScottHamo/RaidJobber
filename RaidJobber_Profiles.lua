...
RaidJobberProfiles.ssc = {
    ...
    bosses = {
        ...
        },
        {
            ...
            jobs = {
                { slot = "Tank 1", phase = "P1/P3", role = "Tank", text = "Phase 1 and Phase 3 boss tank" },
                { slot = "Middle Paladin", phase = "Phase 2", role = "Healer", text = "Holy Paladin stands middle with Righteous Fury" },
                { slot = "Strider Kiter", phase = "Phase 2", role = "Ranged", text = "Kite Coilfang Strider; prefer Mage, then Shaman, then Hunter" },
                { slot = "Strider Slow", phase = "Phase 2", role = "Ranged", text = "Backup slow and control for Coilfang Strider" },
                { slot = "Naga Tank 1", phase = "Phase 2", role = "Tank", text = "Pick up Coilfang Elite" },
                { slot = "Naga Tank 2", phase = "Phase 2", role = "Tank", text = "Backup Elite pickup" },
                { slot = "Area 1", phase = "Phase 2", role = "Any", text = "Area 1 core team", members = {
                ...
                { slot = "Area 2", phase = "Phase 2", role = "Any", text = "Area 2 core team", members = {
                ...
                { slot = "Area 3", phase = "Phase 2", role = "Any", text = "Area 3 core team", members = {
                ...
                { slot = "Area 4", phase = "Phase 2", role = "Any", text = "Area 4 core team", members = {
                ...
                { slot = "Spore Bats 1", phase = "Phase 3", role = "Ranged", text = "Hunter assigned to Spore Bats in Phase 3" },
                { slot = "Spore Bats 2", phase = "Phase 3", role = "Ranged", text = "Backup Hunter assigned to Spore Bats in Phase 3" },
                { slot = "Healer 1", phase = "P1/P3", role = "Healer", text = "Main tank healer" },
                { slot = "Raid", phase = "P1/P3", role = "All", text = "Spread for Static Charge and keep moving out of poison" },
            },
        },
    },
}

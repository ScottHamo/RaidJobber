    ...
    bosses = {
        ...
        },
        {
            ...
            jobs = {
                ...
                { slot = "Strider Control 1", role = "Ranged", text = "Kite or slow Coilfang Strider" },
                { slot = "Strider Control 2", role = "Ranged", text = "Backup Strider slow and control" },
                { slot = "Naga Tank 1", role = "Tank", text = "Pick up Coilfang Elite" },
                { slot = "Naga Tank 2", role = "Tank", text = "Backup Elite pickup" },
                { slot = "Core Runner 1", role = "Any", text = "Tainted Core lane 1" },
                { slot = "Core Runner 2", role = "Any", text = "Tainted Core lane 2" },
                { slot = "Core Runner 3", role = "Any", text = "Tainted Core lane 3" },
                { slot = "Core Runner 4", role = "Any", text = "Tainted Core lane 4" },
                { slot = "Generator 1", role = "Any", text = "Disable shield generator 1" },
                { slot = "Generator 2", role = "Any", text = "Disable shield generator 2" },
                { slot = "Generator 3", role = "Any", text = "Disable shield generator 3" },
                { slot = "Generator 4", role = "Any", text = "Disable shield generator 4" },
                { slot = "Healer 1", role = "Healer", text = "Main tank healer" },
                { slot = "Healer 2", role = "Healer", text = "Strider lane healer" },
                { slot = "Healer 3", role = "Healer", text = "Core team healer" },
